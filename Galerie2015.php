...
<!-- Beginn container - schlie�t erst ganz am Ende -->
 ...
 include ('menue.html');
 ?>
  <!-- Navig <!-- Beginn Galerie -->

<div class ="galerie">
  <div class ="galerie_text">
  <h2> Leps vs. Gammertingen 02.08.2015 </h2>
  <hr>
    <ul>
    <div class = "box1">
     ...
     <div class = "box2">
      ...
      <li><a class="fancybox" rel="group" href="Galerie/Galerie2015/Rav_Gam_12.jpg" title="Leps gegen Gammertingen"> <img src="Galerie/Galerie2015/Rav_Gam_12_kl.jpg" alt="Ravensburg-Gammertingen"> </a></li>
     </div>
    </ul>
    </div>
      </div>
